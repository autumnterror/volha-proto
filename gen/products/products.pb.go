...
const file_products_products_proto_rawDesc = "" +
	...
	"\aarticle\x18\x03 \x01(\tR\aarticle\"\xf5\x02\n" +
	"\aProduct\x12\x0e\n" +
	"\x02Id\x18\x01 \x01(\tR\x02Id\x12\x14\n" +
	"\x05Title\x18\x02 \x01(\tR\x05Title\x12\x18\n" +
	...
	"\tColorList\x12'\n" +
	"\x06colors\x18\x01 \x03(\v2\x0f.products.ColorR\x06colors2\xe5\f\n" +
	"\bProducts\x12A\n" +
...
var file_products_products_proto_goTypes = []any{
	...
	(*Title)(nil),         // 6: products.Title
	(*Brand)(nil),         // 7: products.Brand
	(*BrandList)(nil),     // 8: products.BrandList
	(*Category)(nil),      // 9: products.Category
	(*CategoryList)(nil),  // 10: products.CategoryList
	(*Country)(nil),       // 11: products.Country
	(*CountryList)(nil),   // 12: products.CountryList
	(*Material)(nil),      // 13: products.Material
	(*MaterialList)(nil),  // 14: products.MaterialList
	(*Color)(nil),         // 15: products.Color
	(*ColorList)(nil),     // 16: products.ColorList
	(*emptypb.Empty)(nil), // 17: google.protobuf.Empty
}
var file_products_products_proto_depIdxs = []int32{
	8,  // 0: products.Dictionaries.brands:type_name -> products.BrandList
	10, // 1: products.Dictionaries.categories:type_name -> products.CategoryList
	12, // 2: products.Dictionaries.countries:type_name -> products.CountryList
	14, // 3: products.Dictionaries.materials:type_name -> products.MaterialList
	16, // 4: products.Dictionaries.colors:type_name -> products.ColorList
	2,  // 5: products.ProductList.products:type_name -> products.Product
	7,  // 6: products.BrandList.brands:type_name -> products.Brand
	9,  // 7: products.CategoryList.categories:type_name -> products.Category
	11, // 8: products.CountryList.countries:type_name -> products.Country
	13, // 9: products.MaterialList.materials:type_name -> products.Material
	15, // 10: products.ColorList.colors:type_name -> products.Color
	17, // 11: products.Products.GetDictionaries:input_type -> google.protobuf.Empty
	1,  // 12: products.Products.SearchProducts:input_type -> products.ProductSearch
	2,  // 13: products.Products.CreateProduct:input_type -> products.Product
	2,  // 14: products.Products.UpdateProduct:input_type -> products.Product
	5,  // 15: products.Products.DeleteProduct:input_type -> products.Id
	17, // 16: products.Products.GetAllProducts:input_type -> google.protobuf.Empty
	4,  // 17: products.Products.FilterProducts:input_type -> products.ProductFilter
	7,  // 18: products.Products.CreateBrand:input_type -> products.Brand
	7,  // 19: products.Products.UpdateBrand:input_type -> products.Brand
	5,  // 20: products.Products.DeleteBrand:input_type -> products.Id
	17, // 21: products.Products.GetAllBrands:input_type -> google.protobuf.Empty
	9,  // 22: products.Products.CreateCategory:input_type -> products.Category
	9,  // 23: products.Products.UpdateCategory:input_type -> products.Category
	5,  // 24: products.Products.DeleteCategory:input_type -> products.Id
	17, // 25: products.Products.GetAllCategories:input_type -> google.protobuf.Empty
	11, // 26: products.Products.CreateCountry:input_type -> products.Country
	11, // 27: products.Products.UpdateCountry:input_type -> products.Country
	5,  // 28: products.Products.DeleteCountry:input_type -> products.Id
	17, // 29: products.Products.GetAllCountries:input_type -> google.protobuf.Empty
	13, // 30: products.Products.CreateMaterial:input_type -> products.Material
	13, // 31: products.Products.UpdateMaterial:input_type -> products.Material
	5,  // 32: products.Products.DeleteMaterial:input_type -> products.Id
	17, // 33: products.Products.GetAllMaterials:input_type -> google.protobuf.Empty
	15, // 34: products.Products.CreateColor:input_type -> products.Color
	15, // 35: products.Products.UpdateColor:input_type -> products.Color
	5,  // 36: products.Products.DeleteColor:input_type -> products.Id
	17, // 37: products.Products.GetAllColors:input_type -> google.protobuf.Empty
	0,  // 38: products.Products.GetDictionaries:output_type -> products.Dictionaries
	3,  // 39: products.Products.SearchProducts:output_type -> products.ProductList
	17, // 40: products.Products.CreateProduct:output_type -> google.protobuf.Empty
	17, // 41: products.Products.UpdateProduct:output_type -> google.protobuf.Empty
	17, // 42: products.Products.DeleteProduct:output_type -> google.protobuf.Empty
	3,  // 43: products.Products.GetAllProducts:output_type -> products.ProductList
	3,  // 44: products.Products.FilterProducts:output_type -> products.ProductList
	17, // 45: products.Products.CreateBrand:output_type -> google.protobuf.Empty
	17, // 46: products.Products.UpdateBrand:output_type -> google.protobuf.Empty
	17, // 47: products.Products.DeleteBrand:output_type -> google.protobuf.Empty
	8,  // 48: products.Products.GetAllBrands:output_type -> products.BrandList
	17, // 49: products.Products.CreateCategory:output_type -> google.protobuf.Empty
	17, // 50: products.Products.UpdateCategory:output_type -> google.protobuf.Empty
	17, // 51: products.Products.DeleteCategory:output_type -> google.protobuf.Empty
	10, // 52: products.Products.GetAllCategories:output_type -> products.CategoryList
	17, // 53: products.Products.CreateCountry:output_type -> google.protobuf.Empty
	17, // 54: products.Products.UpdateCountry:output_type -> google.protobuf.Empty
	17, // 55: products.Products.DeleteCountry:output_type -> google.protobuf.Empty
	12, // 56: products.Products.GetAllCountries:output_type -> products.CountryList
	17, // 57: products.Products.CreateMaterial:output_type -> google.protobuf.Empty
	17, // 58: products.Products.UpdateMaterial:output_type -> google.protobuf.Empty
	17, // 59: products.Products.DeleteMaterial:output_type -> google.protobuf.Empty
	14, // 60: products.Products.GetAllMaterials:output_type -> products.MaterialList
	17, // 61: products.Products.CreateColor:output_type -> google.protobuf.Empty
	17, // 62: products.Products.UpdateColor:output_type -> google.protobuf.Empty
	17, // 63: products.Products.DeleteColor:output_type -> google.protobuf.Empty
	16, // 64: products.Products.GetAllColors:output_type -> products.ColorList
